...
if ( ! function_exists( 'some_like_it_neat_scripts' ) ) :
	function some_like_it_neat_scripts()
	{
		...
		if ( SCRIPT_DEBUG || WP_DEBUG ) :
			...
			wp_register_script( 'main-js', get_template_directory_uri() . '/assets/js/vendor/main.js', array( 'jquery' ), '0.0.6', true );
			wp_enqueue_script( 'main-js', get_template_directory_uri() . '/assets/js/vendor/main.js', array( 'jquery' ), '1.0.6', true );
			...
			wp_register_script( 'main-js', get_template_directory_uri() . '/assets/js/vendor/main.js', array( 'jquery' ), '1.0.6', true );
			wp_enqueue_script( 'main-js', get_template_directory_uri() . '/assets/js/vendor/main.js', array( 'jquery' ), '1.0.6', true );
	...
	function some_like_it_neat_styles() {
		if ( SCRIPT_DEBUG || WP_DEBUG ) :
			wp_register_style(
				...
				get_template_directory_uri() . '/assets/css/style.css', '', '2.0', 'screen'
			);
			...
			wp_register_style(
				'some_like_it_neat-style', // handle name
				get_template_directory_uri() . '/assets/css/style-min.css', '', '2.0', 'screen'
			);
			wp_enqueue_style( 'some_like_it_neat-style' );
		endif;
	}
